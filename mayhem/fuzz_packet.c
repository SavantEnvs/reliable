...
// NB: at this UPSTREAM revision reliable_config_t predates the id/uint64_t rename — the
// callback signatures take an `int index`, matching upstream's own fuzz.c of this era.
